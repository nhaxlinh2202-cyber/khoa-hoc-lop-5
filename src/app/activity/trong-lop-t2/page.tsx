      ...
      >
        ...
        <header className="flex-none p-3 md:p-6 border-b-4 border-black bg-gray-50 flex items-center justify-between z-50 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-3xl lg:text-4xl font-black font-sans uppercase text-black truncate hidden sm:block py-1 leading-relaxed">GIAI ĐOẠN 2: TIẾT 2</h1>
          </div>
